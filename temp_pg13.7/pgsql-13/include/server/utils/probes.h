...
/* TRACE_POSTGRESQL_BUFFER_READ_START ( int, unsigned int, unsigned int, unsigned int, unsigned int, int, unsigned char ) */
#if defined STAP_SDT_V1
...
/* TRACE_POSTGRESQL_BUFFER_READ_DONE ( int, unsigned int, unsigned int, unsigned int, unsigned int, int, unsigned char, unsigned char ) */
#if defined STAP_SDT_V1
